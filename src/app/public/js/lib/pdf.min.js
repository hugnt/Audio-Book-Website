    ...
    var __webpack_modules__ = [
        ...
        (e, t, r) => {
          ...
          t.addLinkAttributes = function addLinkAttributes(
            e,
            { url: t, target: r, rel: i, enabled: o = !0 } = {}
          ) {
            (0, n.assert)(
              t && "string" == typeof t,
                    ...
                    i.onreadystatechange = () => {
                      if (i.readyState === XMLHttpRequest.DONE) {
                        if (200 === i.status || 0 === i.status) {
                          let e;
                          this.isCompressed && i.response
                            ? (e = new Uint8Array(i.response))
                            : !this.isCompressed &&
                              i.responseText &&
                              (e = (0, n.stringToBytes)(i.responseText));
                          if (e) {
        ...
        (e, t, r) => {
          ...
          class Util {
            ...
            static getAxialAlignedBoundingBox(e, t) {
              ...
              return [
                Math.min(r[0], n[0], s[0], i[0]),
                Math.min(r[1], n[1], s[1], i[1]),
                Math.max(r[0], n[0], s[0], i[0]),
                Math.max(r[1], n[1], s[1], i[1]),
              ];
            }
          ...
          t.AnnotationStorage = class AnnotationStorage {
            ...
            getAll() {
              return 0 === this._storage.size
                ? null
                : (0, n.objectFromEntries)(this._storage);
            }
            get size() {
          ...
          const l = (function CanvasExtraStateClosure() {
            ...
            c = (function CanvasGraphicsClosure() {
              ...
              function composeSMask(e, t, r, n) {
                ...
                if (t.transferMap || !n.isEnabled) {
                  !(function genericComposeSMask(e, t, r, n, s, i, a) {
                    ...
                    for (let s = 0; s < n; s += u) {
                      const i = Math.min(u, n - s),
                        p = e.getImageData(0, s, r, i),
              ...
              CanvasGraphics.prototype = {
                ...
                executeOperatorList:
                  function CanvasGraphics_executeOperatorList(e, t, r, s) {
                    const i = e.argsArray,
                      a = e.fnArray;
                    let o = t || 0;
                    const l = i.length;
                    ...
                    for (;;) {
                      ...
                      f = a[o];
                      if (f !== n.OPS.dependency) this[f].apply(this, i[o]);
                      else
                        for (const e of i[o]) {
                ...
                stroke: function CanvasGraphics_stroke(e) {
                  ...
                  if (this.contentVisible)
                    if ("object" == typeof r && r?.getPattern) {
                      ...
                      const i = this.getSinglePixelWidth(),
                ...
                showText: function CanvasGraphics_showText(e) {
                  ...
                  for (S = 0; S < d; ++S) {
                    ...
                    if (this.contentVisible && (t.isInFont || r.missingFile))
                      if (m && !y) i.fillText(_, v, x);
                      else {
                        this.paintChar(_, v, x, A, b);
                        if (y) {
                          const e = v + (s * y.offset.x) / a,
                            t = x - (s * y.offset.y) / a;
                ...
                showType3Text: function CanvasGraphics_showType3Text(e) {
                  ...
                  let p, f, g, m;
                  if (
                    !(r.textRenderingMode === n.TextRenderingMode.INVISIBLE) &&
                    0 !== i
                  ) {
                    this._cachedGetSinglePixelWidth = null;
                    t.save();
                ...
                shadingFill: function CanvasGraphics_shadingFill(e) {
                  ...
                  if (i) {
                    const e = t.canvas,
                      ...
                      o = n.Util.applyTransform([0, s], i),
                      l = n.Util.applyTransform([r, 0], i),
                      c = n.Util.applyTransform([r, s], i),
                          ...
                          ? (function compileType3Glyph(e) {
                              ...
                              return function (e) {
                                ...
                                for (let t = 0, r = m.length; t < r; t++) {
                                  const r = m[t];
                                  e.moveTo(r[0], r[1]);
                                  for (let t = 2, n = r.length; t < n; t += 2)
                                    e.lineTo(r[t], r[t + 1]);
                                }
                                e.fill();
                                e.beginPath();
                ...
                paintInlineImageXObject:
                  function CanvasGraphics_paintInlineImageXObject(e) {
                    ...
                    let h,
                      d,
                      u,
                      p = Math.max(Math.sqrt(l * l + c * c), 1);
                    if (
                ...
                getSinglePixelWidth() {
                  if (null === this._cachedGetSinglePixelWidth) {
                    ...
                    r !== n && this._combinedScaleFactor * s > 1
                      ? (this._cachedGetSinglePixelWidth =
                          -this._combinedScaleFactor * s)
                      : t > Number.EPSILON
                      ? (this._cachedGetSinglePixelWidth = 1.0000001 * s)
            ...
            fromIR: function RadialAxial_fromIR(e) {
              ...
              return {
                getPattern: function RadialAxial_getPattern(e) {
                  ...
                  let l;
                  "axial" === t
                    ? (l = e.createLinearGradient(s[0], s[1], i[0], i[1]))
                    : "radial" === t &&
          ...
          const i = (function createMeshCanvasClosure() {
            function drawTriangle(e, t, r, n, s, i, a, o) {
              ...
              const p = (l[r] + t.offsetX) * t.scaleX,
                ...
                A = (l[s] + t.offsetX) * t.scaleX,
                _ = (l[s + 1] + t.offsetY) * t.scaleY;
              if (f >= _) return;
              const b = c[i],
                y = c[i + 1],
                S = c[i + 2],
          ...
          const a = (function TilingPatternClosure() {
            ...
            TilingPattern.prototype = {
              ...
              setFillAndStrokeStyleToContext:
                function setFillAndStrokeStyleToContext(r, s, i) {
                  const a = r.ctx,
                    o = r.current;
                  switch (s) {
                    case e:
          ...
          t.Metadata = class Metadata {
            ...
            _getCreators(e) {
              ...
              const t = e.childNodes[0],
                r = this._getSequence(t) || [];
              this._metadataMap.set(
                e.nodeName,
                r.map((e) => e.textContent.trim())
              );
              return !0;
            }
            _parse(e) {
            ...
            class XMLParserBase {
              ...
              _parseContent(e, t) {
                ...
                for (
                  ...
                  for (
                    ;
                    n < e.length && !isWhitespace(e, n) && "=" !== e[n];
                  ...
                  if ("<" === e[t]) {
                    ...
                    switch (e[r]) {
                      ...
                      case "?":
                        ...
                        if (
                          "?>" !== e.substring(r + n.parsed, r + n.parsed + 2)
                        ) {
                          this.onError(a);
                          return;
                        }
                      ...
                      default:
                        ...
                        let d = !1;
                        if (
                          "/>" === e.substring(r + s.parsed, r + s.parsed + 2)
                        )
                          d = !0;
                        else if (
                          ">" !== e.substring(r + s.parsed, r + s.parsed + 1)
                        ) {
                          this.onError(h);
                          return;
                        }
        ...
        (e, t, r) => {
          ...
          t.OptionalContentConfig = class OptionalContentConfig {
            ...
            getGroups() {
              return this._groups.size
                ? (0, n.objectFromEntries)(this._groups)
                : null;
            }
            getGroup(e) {
          ...
          const s = (function WebGLUtilsClosure() {
            ...
            return {
              ...
              composeSMask: function composeSMask(n, s, i) {
                ...
                r ||
                  (function initSmaskGL() {
                    ...
                    const o = s.getAttribLocation(i, "a_texCoord"),
                      l = s.getUniformLocation(i, "u_image"),
                      c = s.getUniformLocation(i, "u_mask"),
                      h = s.createBuffer();
              ...
              drawFigures: function drawFigures(r, s, i, a, o) {
                ...
                i
                  ? h.clearColor(i[0] / 255, i[1] / 255, i[2] / 255, 1)
                  : h.clearColor(0, 0, 0, 0);
                h.clear(h.COLOR_BUFFER_BIT);
          ...
          class AnnotationElement {
            ...
            _createContainer(e = !1) {
              ...
              if (!e && t.borderStyle.width > 0) {
                ...
                t.color
                  ? (i.style.borderColor = s.Util.makeHexColor(
                      0 | t.color[0],
                      0 | t.color[1],
                      0 | t.color[2]
                    ))
            ...
            _setEventListeners(e, t, r) {
              for (const [n, s] of t)
                ("Action" === s || this.data.actions?.[s]) &&
                  this._setEventListener(e, n, s, r);
            }
          }
          class TextWidgetAnnotationElement extends WidgetAnnotationElement {
                ...
                if (this.enableScripting && this.hasJSActions) {
                      ...
                      i = {
                        ...
                        valueAsString() {
                          ...
                          r.target !== document.activeElement &&
                            (r.target.value = s.formattedValue);
                          e.setValue(t, { formattedValue: s.formattedValue });
                        },
                        focus() {
                          setTimeout(
                            () => r.target.focus({ preventScroll: !1 }),
                            0
                          );
                        },
                        userName() {
                        ...
                        hidden() {
                          r.target.style.visibility = n.hidden
                            ? "hidden"
                            : "visible";
                        ...
                        selRange() {
                          ...
                          e >= 0 &&
                            t < r.target.value.length &&
                            r.target.setSelectionRange(e, t);
                        },
                        strokeColor() {
                          const e = n.strokeColor;
                          r.target.style.color = a.ColorConverters[
                            `${e[0]}_HTML`
                          ](e.slice(1));
                        },
                      };
                  ...
                  if (this.data.actions) {
                    ...
                    r.addEventListener("select", (e) => {
                      s.beforeInputSelectionRange = [
                        e.target.selectionStart,
                        e.target.selectionEnd,
                      ];
                    });
                    "Keystroke" in this.data.actions &&
                      r.addEventListener("input", (e) => {
                        let r = -1,
                          n = -1;
                        s.beforeInputSelectionRange &&
                          ([r, n] = s.beforeInputSelectionRange);
                        this.linkService.eventBus?.dispatch(
                          "dispatcheventinsandbox",
                          {
                            source: this,
            ...
            _setTextStyle(e) {
              const t = ["left", "center", "right"],
                { fontSize: r, fontColor: n } = this.data.defaultAppearanceData,
                i = e.style;
              r && (i.fontSize = `${r}px`);
            ...
            static render(e) {
              ...
              for (const r of t) {
                const t = AnnotationElementFactory.create({
                  ...
                  annotationStorage:
                    e.annotationStorage || new i.AnnotationStorage(),
        ...
        (e, t) => {
          ...
          t.ColorConverters = class ColorConverters {
            static CMYK_G([e, t, r, n]) {
              return ["G", 1 - Math.min(1, 0.3 * e + 0.59 * r + 0.11 * t + n)];
            }
            static G_CMYK([e]) {
        ...
        (e, t, r) => {
          ...
          const s = (function renderTextLayerClosure() {
            ...
            function appendText(t, r, s) {
              ...
              f &&
                (c.vertical
                  ? (a.canvasWidth = r.height * t._viewport.scale)
                  : (a.canvasWidth = r.width * t._viewport.scale));
              t._textDivProperties.set(i, a);
              ...
              if (t._enhanceTextSelection) {
                ...
                const a = (c.vertical ? r.height : r.width) * t._viewport.scale,
                  o = h;
                let p, f;
                if (0 !== l) {
                  p = [e, s, -s, e, d, u];
            ...
            function expandBoundsLTR(e, t) {
              ...
              t.forEach(function (e) {
                ...
                for (a = t; a <= i; a++) {
                  ...
                  let e = !1;
                  for (o = t - 1; !e && o >= 0 && r[o].start >= s.y1; o--)
                    e = r[o].boundary === s;
                  for (o = i + 1; !e && o < r.length && r[o].end <= s.y2; o++)
                    e = r[o].boundary === s;
            ...
            TextLayerRenderTask.prototype = {
              ...
              _layoutText(e) {
                ...
                if (0 !== t.canvasWidth) {
                  ...
                  const { width: i } = this._layoutTextCtx.measureText(
                    e.textContent
                  );
                  if (i > 0) {
                ...
                for (let n = 0, s = this._textDivs.length; n < s; n++) {
                  ...
                  if (!i.isWhitespace)
                    if (e) {
                      ...
                      i.paddingRight > 0
                        ? r.push(i.paddingRight / i.scale + "px")
                        : r.push(0);
                      i.paddingBottom > 0
                        ? r.push(`${i.paddingBottom}px`)
                        : r.push(0);
                      if (i.paddingLeft > 0) {
            ...
            t.SVGGraphics = SVGGraphics = class SVGGraphics {
              ...
              _makeTilingPattern(e) {
                const t = e[1],
                  ...
                  d = e[7],
                  p = "shading" + u++,
                  [f, g] = n.Util.applyTransform([i, a], s),
                ...
                const v = this.svg,
                  ...
                  R = this.svgFactory.create(m - f, A - g);
                this.svg = R;
            ...
            constructor(e) {
              ...
              const handleResponse = (t) => {
                ...
                const getResponseHeader = (e) =>
                  ...
                  { allowRangeRequests: r, suggestedLength: i } = (0,
          ...
          class PDFNodeStreamFsRangeReader extends BaseRangeReader {
            constructor(e, t, r) {
              ...
              this._setReadableStream(
                i.createReadStream(n, { start: t, end: r - 1 })
              );
            }
          }
        },
              ...
              fetch(
                ...
                .then((e) => {
                  ...
                  const getResponseHeader = (t) => e.headers.get(t),
                    { allowRangeRequests: t, suggestedLength: i } = (0,
                    s.validateRangeRequestCapabilities)({
                      getResponseHeader: getResponseHeader,
